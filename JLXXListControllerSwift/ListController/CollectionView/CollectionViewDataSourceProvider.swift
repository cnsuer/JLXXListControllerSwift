...
public class CollectionViewSectionItem {
...
class CollectionViewDataSourceProvider: NSObject {
	
	public var dataSource: CollectionViewDataSourceProtocol
	...
	*/
	...
	init(dataSource: CollectionViewDataSourceProtocol, layout: UICollectionViewLayout , delegate: AnyObject?) {
	...
	*/
	public func addSectionItem(count: Int) {
		for _ in 0..<count {
			sectionItems.append(CollectionViewSectionItem())
		}
	}
	...
	*/
	public func getSectionItem(at section: Int) -> CollectionViewSectionItem {
...
extension CollectionViewDataSourceProvider: UICollectionViewDataSource {
